...
const SystemLogsTableRow: React.FC<SystemLogsTableRowProps> = ({ data }) => {
    return (
        <div className="group flex flex-row items-center w-full h-[2.92vw] bg-[#222222] border-b border-[#666666]/50 hover:bg-white/[0.02] transition-colors shrink-0 relative font-['SF_Pro_Text']">
            {/* Timestamp: 15% */}
