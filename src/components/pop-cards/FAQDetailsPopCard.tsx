...
const FAQDetailsPopCard: React.FC<FAQDetailsPopCardProps> = ({ question, answer, onClose }) => {
    ...
    return (
        <PopCardWrapper>
            <div className="relative flex flex-col items-center p-[1.66vw] gap-[1.66vw] bg-[#16003F] border border-[#666666]/50 backdrop-blur-[12px] rounded-[1.66vw] box-border shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 w-[49.79vw] min-w-[600px] min-h-[300px]">
                {/* Header Row */}
