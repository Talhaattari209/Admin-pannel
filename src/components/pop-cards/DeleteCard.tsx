        ...
        <PopCardWrapper onClose={onCancel}>
            ...
            >
                ...
                <div className="flex flex-row items-center justify-center gap-[1.25vw] self-stretch mt-auto">
                    ...
                    <button
                        onClick={onConfirm}
                        className="flex-1 h-[2.92vw] bg-[#FF4E4E] rounded-[2.71vw] text-white font-medium not-italic text-[0.83vw] shadow-[0px_-0.42vw_0.63vw_rgba(255,78,78,0.25),0px_0.42vw_0.63vw_rgba(255,78,78,0.25)] hover:brightness-110 active:scale-95 transition-all cursor-pointer"
                    >
                        {confirmText}
                    </button>
                </div>
