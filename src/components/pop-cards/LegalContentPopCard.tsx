...
const LegalContentPopCard: React.FC<LegalContentPopCardProps> = ({ onCancel, onSave, initialTitle = '', initialContent = '', initialStatus = 'draft', mode = 'add' }) => {
    ...
    return (
        <PopCardWrapper onClose={onCancel}>
            <div className="relative flex flex-col items-center p-[1.66vw] gap-[1.25vw] bg-[#16003F] border border-[#666666]/50 backdrop-blur-[12px] rounded-[1.66vw] box-border shadow-2xl overflow-hidden w-[49.79vw] h-[48.64vw] min-w-[600px] max-h-[90vh]">
                {/* Header Row */}
