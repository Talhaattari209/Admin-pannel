...
const LegalContentPopCard: React.FC<LegalContentPopCardProps> = ({ onCancel, onSave, initialTitle = '', initialContent = '', mode = 'add' }) => {
    ...
    return (
        <PopCardWrapper>
            <div className="relative flex flex-col items-center p-[1.66vw] gap-[1.66vw] bg-[#16003F] border border-[#666666]/50 backdrop-blur-[12px] rounded-[1.66vw] box-border shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 w-[49.79vw] h-[48.64vw] min-w-[600px] max-h-[90vh]">
                {/* Header Row */}
                ...
                <div className="flex flex-row items-center justify-start gap-[1.25vw] w-full shrink-0">
                    <button
                        ...
                        className="w-[7.55vw] h-[2.92vw] bg-[#5F00DB] rounded-[2.71vw] text-white font-medium not-italic text-[0.83vw] shadow-[0px_-0.42vw_0.63vw_rgba(95,0,219,0.25),0px_0.42vw_0.63vw_rgba(95,0,219,0.25)] hover:brightness-110 active:scale-95 transition-all"
                    >
