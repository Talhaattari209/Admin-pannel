...
const DashboardView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full max-w-[79.16vw] mx-auto gap-[1.25vw] p-[1.66vw] animate-in fade-in duration-700">
      ...
      {/* Stats Row */}
      <div className="grid grid-cols-5 gap-[0.83vw] w-full mb-[0.33vw] overflow-visible">
      ...
      <div className="flex flex-nowrap items-center gap-[0.41vw] mb-[0.33vw] w-[70%] overflow-x-auto scrollbar-hide">
        {FILTERS.map((filter) => (
          <button
            ...
            className={`flex-shrink-0 px-[1.25vw] py-[0.27vw] rounded-full text-[0.72vw] font-medium not-italic transition-all duration-300 border cursor-pointer ${activeFilter === filter
