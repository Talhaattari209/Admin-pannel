...
const AddMemberModal: React.FC<AddMemberModalProps> = ({ onCancel, onInvite }) => {
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="relative flex flex-col items-center p-8 gap-8 w-[480px] max-h-[90vh] bg-[#16003F] border border-[#666666]/50 rounded-[32px] shadow-2xl overflow-y-auto no-scrollbar animate-in zoom-in-95 duration-300 backdrop-blur-[12px]">
                {/* Icon */}
                ...
                <div className="flex flex-col gap-6 w-full">
                    ...
                    <div className="flex flex-col gap-1 border-b border-white py-2 relative group">
                        ...
                        <div className="absolute right-0 bottom-3 pointer-events-none text-white/40 group-hover:text-white transition-colors">
