...
const AddRoleModal: React.FC<AddRoleModalProps> = ({ onCancel, onAdd, initialData }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="relative flex flex-col items-center p-8 gap-8 w-[640px] max-w-[90vw] max-h-[90vh] bg-[#16003F] border border-[#666666]/50 rounded-[32px] shadow-2xl overflow-y-auto no-scrollbar animate-in zoom-in-95 duration-300 backdrop-blur-[12px]">
                {/* Icon */}
