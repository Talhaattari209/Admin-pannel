...
const TeamMembersTable: React.FC = () => {
    ...
    const roleOptions = roles.map((r: any) => ({ label: r.title, value: r.id }));
    ...
    return (
        ...
        >
            ...
            {/* Rows */}
            <div className="flex flex-col w-full overflow-visible" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                {isLoading ? (
