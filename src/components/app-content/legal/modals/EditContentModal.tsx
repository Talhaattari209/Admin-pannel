        ...
        >
            <div className="flex flex-col gap-[1.25vw] w-full">
                ...
                <div className="flex flex-col gap-[0.42vw] w-full">
                    <label className="text-white text-[0.63vw] font-bold font-['SF_Pro_Text'] uppercase tracking-wider ml-[0.21vw]">Title</label>
                    <input
                        type="text"
                        value={title}
                ...
                <div className="flex flex-col gap-[0.42vw] w-full">
                    <label className="text-white text-[0.63vw] font-bold font-['SF_Pro_Text'] uppercase tracking-wider ml-[0.21vw]">Content</label>
                    <RichTextEditor
                        value={content}
                        onChange={setContent}
                        height="12.29vw"
