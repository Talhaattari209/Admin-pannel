  ...
  return (
    <div className="flex flex-col p-[1.25vw] bg-[#222222] border border-[#666666]/30 rounded-[0.83vw] gap-[1.67vw] shrink-0 shadow-lg min-h-[23.02vw]">
      <div className="flex flex-col gap-[0.42vw]">
        <h3 className="text-white text-[1.46vw] font-bold font-inter leading-none tracking-tight">Content & Moderation</h3>
        <p className="text-[#CCCCCC] text-[0.83vw] opacity-60 font-inter leading-[150%]">Manage what content is allowed on the platform and set rules for moderation, reporting, and member behavior.</p>
      </div>
      ...
      <div className="flex flex-col gap-[1.25vw]">
        {[
          ...
          <div key={item.id} className="flex items-center justify-between">
            <span className="text-white text-[0.83vw] font-inter">{item.label}</span>
      ...
      <div className="flex flex-row gap-[1.25vw] mt-[0.42vw]">
        <div className="flex-1 flex flex-col gap-[0.21vw] border-b border-white py-[0.21vw]">
          <label className="text-white text-[0.63vw] font-bold uppercase tracking-widest font-inter opacity-80">Auto-Flag Threshold</label>
          <input
            type="text"
            value={thresholds.autoFlag}
            onChange={(e) => inputHandler('autoFlag', e.target.value)}
            className="bg-transparent border-none text-white text-[0.94vw] focus:outline-none font-inter py-[0.21vw]"
          />
        </div>
        <div className="flex-1 flex flex-col gap-[0.21vw] border-b border-white py-[0.21vw]">
          <label className="text-white text-[0.63vw] font-bold uppercase tracking-widest font-inter opacity-80">Max Reports Before Suspension</label>
          <input
            type="text"
