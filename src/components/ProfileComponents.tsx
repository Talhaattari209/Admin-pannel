        ...
        <div className="flex flex-col items-start p-[0.83vw] gap-[1.67vw] w-[59.17vw] h-[28.44vw] bg-[#222222] border border-[rgba(102,102,102,0.5)] rounded-[0.83vw]">
            ...
            <div className="flex flex-col items-start gap-[0.83vw] w-[57.5vw] h-[4.69vw] relative">
                <div className="flex flex-col gap-[0.83vw] pb-[0.83vw] w-full">
                    <h3 className="font-['SF_Pro_Text'] font-bold text-[1.46vw] leading-[120%] tracking-[-0.04em] text-white">Prompts</h3>
                    <p className="font-['SF_Pro_Text'] font-normal text-[0.83vw] leading-[150%] text-[#CCCCCC]">Review and moderate the user’s responses to personality and icebreaker prompts.</p>
                </div>
                {/* Gradient Line */}
            ...
            <div className="flex flex-col items-start gap-[0.83vw] w-[57.5vw] h-[20.42vw]">
                ...
                <div className="flex flex-col items-start p-[0.83vw] gap-[0.83vw] w-[57.5vw] h-[7.08vw] bg-[#111111]/50 backdrop-blur-[6px] rounded-[1.25vw]">
                    ...
                    <div className="flex flex-row items-center w-[55.83vw] h-[1.67vw] gap-[0.83vw]">
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.94vw] leading-[1.67vw] text-white flex-grow">A perfect weekend for me looks like...</span>
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.73vw] leading-[150%] text-[#EEEEEE] opacity-50 text-right w-[11.35vw]">Added: Nov 10, 2025 • 08:00 PM</span>
                        <div
                    ...
                    <div className="flex flex-row items-center p-[0.21vw] gap-[0.63vw] w-[55.83vw] h-[2.92vw] bg-[#16003F] rounded-[2.5vw]">
                        ...
                        <div className="w-[2.29vw] h-[0.73vw] flex items-center justify-center mr-[0.63vw] flex-shrink-0">
                            <span className="font-['SF_Pro_Text'] font-normal text-[0.63vw] leading-[0.73vw] text-white text-center">00:16</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-start p-[0.83vw] gap-[0.83vw] w-[57.5vw] h-[5.83vw] bg-[#111111]/50 backdrop-blur-[6px] rounded-[1.25vw]">
                    <div className="flex flex-row items-center w-[55.83vw] h-[1.67vw] gap-[0.83vw]">
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.94vw] leading-[1.67vw] text-white flex-grow">My friends describe me as...</span>
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.73vw] leading-[150%] text-[#EEEEEE] opacity-50 text-right w-[11.35vw]">Added: Nov 10, 2025 • 08:00 PM</span>
                        <div
                            className="flex justify-center items-center w-[1.67vw] h-[1.67vw] bg-[#FF4E4E] shadow-[0px_0px_4px_rgba(95,0,219,0.25),0px_4px_12px_rgba(95,0,219,0.25)] rounded-full cursor-pointer hover:bg-[#ff3333] transition-colors"
                            onClick={() => setIsRemoveOpen(true)}
                    ...
                    <div className="w-[55.83vw] h-[1.67vw]">
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.94vw] leading-[1.67vw] text-[#CCCCCC]">Quiet at first, but the funniest one once you know me.</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-start p-[0.83vw] gap-[0.83vw] w-[57.5vw] h-[5.83vw] bg-[#111111]/50 backdrop-blur-[6px] rounded-[1.25vw]">
                    <div className="flex flex-row items-center w-[55.83vw] h-[1.67vw] gap-[0.83vw]">
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.94vw] leading-[1.67vw] text-white flex-grow">Two truths and a lie...</span>
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.73vw] leading-[150%] text-[#EEEEEE] opacity-50 text-right w-[11.35vw]">Added: Nov 10, 2025 • 08:00 PM</span>
                        <div
                            className="flex justify-center items-center w-[1.67vw] h-[1.67vw] bg-[#FF4E4E] shadow-[0px_0px_4px_rgba(95,0,219,0.25),0px_4px_12px_rgba(95,0,219,0.25)] rounded-full cursor-pointer hover:bg-[#ff3333] transition-colors"
                            onClick={() => setIsRemoveOpen(true)}
                    ...
                    <div className="w-[55.83vw] h-[1.67vw]">
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.94vw] leading-[1.67vw] text-[#CCCCCC]">I’ve skydived, I hate pizza, I can juggle three oranges.</span>
                    </div>
                </div>
            </div>
...
const MatchDetailCard = ({
    ...
    return (
        <div className="flex flex-col p-[0.83vw] gap-[0.83vw] w-[28.33vw] h-[14.01vw] bg-[#111111] backdrop-blur-[6px] rounded-[1.25vw] border border-white/5 shrink-0 font-['SF_Pro_Text']">
            {/* Status Row */}
            <div className="flex flex-row items-center justify-between w-full h-[1.67vw]">
                <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] leading-[150%] text-[#CCCCCC]">Status</span>
            ...
            <div className="flex flex-row items-center justify-between w-full h-[1.25vw]">
                <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] leading-[150%] text-[#CCCCCC]">{statusDateLabel}</span>
                <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] leading-[150%] text-white text-right">{statusDate}</span>
            </div>

            {/* Member Count Row */}
            <div className="flex flex-row items-center justify-between w-full h-[1.25vw]">
                <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] leading-[150%] text-[#CCCCCC]">Group Members</span>
                <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] leading-[150%] text-white text-right">{memberCount}</span>
            </div>
    ...
    return (
        <div className="flex flex-col items-start p-[0.83vw] gap-[1.67vw] w-[59.17vw] bg-[#222222] border border-[rgba(102,102,102,0.5)] rounded-[0.83vw] h-[47.58vw]">
            ...
            <div className="w-full relative pb-[0.83vw]">
                <div className="flex flex-col gap-[0.83vw]">
                    <h3 className="font-['SF_Pro_Text'] font-bold text-[1.46vw] leading-[120%] tracking-[-0.04em] text-white">Matches</h3>
                    <p className="font-['SF_Pro_Text'] font-normal text-[0.83vw] leading-[150%] text-[#CCCCCC]">Monitor user’s group matches, including status and last activity.</p>
                </div>
        ...
        <div className="flex flex-row items-center w-[57.5vw] h-[2.92vw] border-b border-[#333333] px-[0.63vw] bg-[#1a1a1a] hover:bg-[#FFFFFF]/5 transition-colors">
            ...
            <div className="flex flex-row items-center gap-[0.42vw] w-[10.42vw]">
                ...
                <div className="flex flex-col justify-center gap-[0.21vw]">
                    ...
                    <span className="font-['SF_Pro_Text'] font-light text-[0.57vw] leading-[0.83vw] tracking-[0.02em] text-white/50">
                        {item.user.email}
                    </span>
                </div>
            </div>
            ...
            <div className="flex flex-row items-center w-[22.08vw]">
                <span className="font-['SF_Pro_Text'] font-normal text-[0.73vw] leading-[0.83vw] text-[#CCCCCC] truncate pr-[1vw]">
                    {item.details}
                </span>
            </div>
            ...
            <div className="flex flex-row items-center w-[7.29vw]">
                <div className={`flex flex-row justify-center items-center px-[0.63vw] py-[0.21vw] rounded-[0.83vw] h-[1.67vw] ${getStatusStyle(item.status)}`}>
                    <span className="font-['SF_Pro_Text'] font-normal text-[0.73vw] leading-[0.83vw]">
                        {item.status}
                    </span>
                </div>
            </div>
                ...
                <div className="flex flex-row gap-[0.42vw] ml-[0.83vw]">
                    ...
                    >
                        ...
                        <div className="flex flex-row justify-center items-center w-[0.94vw] h-[0.94vw] bg-[#FF4E4E] rounded-[1.25vw]">
                            <span className="font-['SF_Pro_Text'] font-bold text-[0.63vw] leading-[0.73vw] text-white flex items-center justify-center h-full">{sentPokes.length}</span>
                        </div>
                    </button>
                    <button
                    ...
                    >
                        ...
                        <div className="flex flex-row justify-center items-center w-[0.94vw] h-[0.94vw] bg-[#FF4E4E] rounded-[1.25vw]">
                            <span className="font-['SF_Pro_Text'] font-bold text-[0.63vw] leading-[0.73vw] text-white flex items-center justify-center h-full">{receivedPokes.length}</span>
                        </div>
                    </button>
                </div>
                ...
                <div className="flex flex-col w-full h-full border border-[rgba(255,255,255,0.1)] rounded-[0.83vw] overflow-hidden bg-[#1a1a1a]">
                    ...
                    <div className="flex flex-row items-center w-full h-[2.5vw] bg-[#1a1a1a] border-b border-[#333333] px-[0.83vw]">
                        ...
                        <div className="flex flex-row items-center gap-[0.42vw] w-[7.29vw] ml-[0.63vw]">
                            <span className="font-['SF_Pro_Text'] font-normal text-[0.73vw] text-[#CCCCCC] ml-[1vw]">Type</span>
                            <ArrowUpDown className="w-[0.73vw] h-[0.73vw] text-white/30" />
                        </div>
                        <div className="flex flex-row items-center gap-[0.42vw] w-[22.08vw] ml-[0.63vw]">
                            <span className="font-['SF_Pro_Text'] font-normal text-[0.73vw] text-[#CCCCCC]">Details</span>
                            <ArrowUpDown className="w-[0.73vw] h-[0.73vw] text-white/30" />
                        </div>
                        <div className="flex flex-row items-center gap-[0.42vw] w-[7.29vw] ml-[0.63vw]">
        ...
        <div className="flex flex-row items-center w-full h-[2.92vw] border-b border-[#666666]/50 bg-[#111111] px-[0.63vw] hover:bg-[#FFFFFF]/5 transition-colors">
            ...
            <div className="flex flex-row items-center w-[14.37vw]">
                <div className={`flex items-center justify-center px-[0.63vw] py-[0.42vw] rounded-[0.83vw] h-[1.67vw] ${item.status === 'Successful' ? 'bg-[#3ADC60]' : 'bg-[#FF4E4E]'}`}>
                    <span className={`font-['SF_Pro_Text'] font-normal text-[0.73vw] leading-[0.83vw] ${item.status === 'Successful' ? 'text-black' : 'text-white'}`}>
                        {item.status}
                    </span>
                </div>
            </div>
...
export const ProfileSubscription = () => {
    ...
    return (
        <div className="flex flex-col items-start p-[0.83vw] gap-[1.67vw] w-[59.17vw] bg-[#222222] border border-[rgba(102,102,102,0.5)] rounded-[0.83vw] h-fit min-h-[47.58vw]">
            ...
            <div className="w-full relative pb-[0.83vw]">
                <div className="flex flex-col gap-[0.83vw]">
                    <h3 className="font-['SF_Pro_Text'] font-bold text-[1.46vw] leading-[120%] tracking-[-0.04em] text-white">Subscription & Payments</h3>
                    <p className="font-['SF_Pro_Text'] font-normal text-[0.83vw] leading-[150%] text-[#CCCCCC]">Shows the user’s premium subscription status, poke pack purchases, renewal logs, and transaction history.</p>
                </div>
                {/* Gradient Divider Line */}
                <div className="absolute bottom-0 left-0 w-full h-[1px]" style={{ background: 'linear-gradient(90deg, #5F00DB 0%, rgba(255, 255, 255, 0.1) 100%)' }} />
            </div>
            ...
            <div className="w-[57.51vw] h-[4.58vw] rounded-[0.83vw] p-[0.83vw] flex flex-row items-center justify-between" style={{ background: 'linear-gradient(180deg, #16003F 0%, #111111 100%)' }}>
                <div className="flex items-center h-full">
                    <h4 className="font-['SF_Pro_Text'] font-bold text-[1.25vw] leading-[120%] tracking-[-0.04em] text-white">Fennec Premium</h4>
                </div>
                <div className="flex flex-row gap-[1.67vw] mr-[1vw]">
                    <div className="flex flex-col gap-[0.42vw]">
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] text-[#CCCCCC]">Premium User Since</span>
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] text-white">October 25, 2024</span>
                    </div>
                    <div className="flex flex-col gap-[0.42vw]">
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] text-[#CCCCCC]">Next Billing Date</span>
                        <span className="font-['SF_Pro_Text'] font-normal text-[0.83vw] text-white">November 25, 2025</span>
                    </div>
                </div>
            </div>
