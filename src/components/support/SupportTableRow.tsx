        ...
        <div className="group flex flex-row items-center w-full h-[2.92vw] bg-[#222222] border-b border-[rgba(102,102,102,0.5)] hover:bg-white/[0.05] transition-colors relative shrink-0 ">
            ...
            <div className="w-[2.5vw] p-[0.31vw] flex justify-center items-center relative shrink-0">
                ...
                {isMenuOpen && (
                    <div
                        ref={menuRef}
                        className="absolute top-[80%] right-full mr-[0.42vw] w-[12.5vw] bg-[#1a1a1a] border border-[#666666]/50 rounded-[0.83vw] shadow-2xl z-[1000] overflow-hidden py-[0.42vw] animate-in fade-in slide-in-from-right-2 duration-200"
                    >
                        {[
                            {
