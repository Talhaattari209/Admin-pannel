        ...
        <div className="flex flex-col items-center w-full animate-in fade-in duration-700 font-['SF_Pro_Text']">
            <div className="flex flex-row items-end justify-between w-full h-[80px] mb-10 shrink-0">
                ...
                <Button
                    onClick={onExport}
                    variant="glass"
                    className="!px-[2vw] !py-[0.8vw] h-[2.92vw] gap-[0.63vw] text-[1vw]"
                    iconRight={
            ...
            <div className="flex flex-row gap-[1.5vw] w-full mb-10 overflow-hidden shrink-0 flex-wrap lg:flex-nowrap">
                {stats.map((stat, i) => (
