    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="relative flex flex-col items-center p-8 gap-8 w-[480px] bg-[#16003F] border border-[#666666]/50 rounded-[32px] shadow-2xl animate-in zoom-in-95 duration-300">
        ...
        <div className="relative flex items-center justify-center w-[120px] h-[120px]">
           ...
           <div className="relative w-20 h-20 rounded-full border-2 border-white/20 flex items-center justify-center isolation-auto">
        ...
        <h2 className="text-white text-[32px] font-medium tracking-tight text-center">App Settings Updated</h2>
        
        <button 
          onClick={onDone}
          className="w-full h-[56px] bg-[#5F00DB] rounded-[52px] text-white font-medium shadow-[0px_4px_12px_rgba(95,0,219,0.3)] hover:brightness-110 active:scale-95 transition-all"
        >
          Done
        </button>
      </div>
