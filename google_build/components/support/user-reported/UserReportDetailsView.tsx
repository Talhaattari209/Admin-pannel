    ...
    <div className="flex flex-col w-full max-w-[1520px] mx-auto p-4 md:p-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-row items-center gap-4 w-full h-[80px] mb-10">
        ...
        <div className="flex flex-col flex-grow">
          <h1 className="text-white text-[36px] font-bold tracking-tight">User Report Details</h1>
        ...
        <div className="flex gap-4">
           ...
           <button className="px-8 py-4 bg-[#FF4E4E] rounded-[52px] text-white font-medium shadow-[0px_4px_12px_rgba(255,78,78,0.25)] hover:brightness-110 transition-all">
             Deactivate User
           </button>
        </div>
      </div>
      ...
      <div className="flex flex-row gap-6 w-full items-start">
        <div className="flex flex-col gap-6 flex-[3] min-w-0">
          ...
          <div className="flex flex-col p-8 bg-[#222222] border border-[#666666]/30 rounded-[24px]">
            ...
            <div className="flex flex-row items-center gap-6 mb-8">
              ...
              <div className="flex flex-col flex-grow">
                <div className="flex items-center gap-2">
                  <span className="text-white text-[72px] font-bold tracking-tight leading-none">
              ...
              <button className="px-8 py-3 border border-white rounded-[52px] text-white font-medium hover:bg-white/10 transition-all">
                View User's Profile
              </button>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-white text-[18px] font-normal">{report.category}</p>
            </div>
          </div>
                ...
                <div className="flex flex-col p-4 bg-[#16003F] border border-white/5 rounded-[16px] w-[245px] gap-3 mt-2 hover:border-[#5F00DB]/40 transition-colors cursor-pointer group/card">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col flex-grow min-w-0">
                      <span className="text-white text-[14px] font-semibold truncate">{report.reportedBy.name}</span>
        ...
        <div className="flex-[1] flex flex-col gap-6 bg-[#222222] border border-[#666666]/30 rounded-[24px] p-8 sticky top-8 min-w-[320px]">
          ...
          <button className="w-full h-[56px] bg-[#5F00DB] rounded-[52px] text-white font-semibold text-[16px] shadow-[0px_4px_12px_rgba(95,0,219,0.25)] hover:brightness-110 active:scale-95 transition-all mt-4">
            Update Status
          </button>
        </div>
      </div>
