      ...
      <div className="flex flex-col gap-8 w-full overflow-hidden">
        ...
        <div className="flex items-center gap-6 mt-2">
          <button 
            ...
            className="w-[105px] h-[56px] bg-[#5F00DB] rounded-[52px] text-white font-medium shadow-[0px_-8px_12px_rgba(95,0,219,0.25),0px_8px_12px_rgba(95,0,219,0.25)] hover:brightness-110 active:scale-95 transition-all"
          >
            Update
          </button>
          <button 
